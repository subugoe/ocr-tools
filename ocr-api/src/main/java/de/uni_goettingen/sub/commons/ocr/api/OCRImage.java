 ...
 * representing different possible orientations of an image.
 * 
 * @version 0.9
 * @author abergna
 * @author cmahnke
...
public interface OCRImage {
	...
	/**
	 * Gets the {@link Orientation} of an image.
	 * 
	 * @return the rotation
	 */
	...
	/**
	 * Sets the rotation of an image. Not all engines support this setting and may
	 * return garbage. If in doubt rotate the image files before recognizing them.
	 * 
	 * @param orientation
	...
	/**
	 * The Enum Orientation. Orientation is expressed clockwise. 
	 */
	public enum Orientation {
		...
		/** MIXED represents uncertain rotation or an image with text floating in multiple directions. */
		MIXED(-1);
