 ...
 * 
 * {@link OCRProcessMetadata} and it's results This can be used to Creating a
 * TextMD, there are two methods which can provide textMD
 * 
 * @author abergna
 */
...
public interface SerializerTextMD {
	...
	/**
	 * Write. This can be used to Creating a TextMD
	 * 
	 * @param file
	 *            the file
	 */
