...
import de.unigoettingen.sub.commons.ocrComponents.hazelcast.AbbyyOCRProcess;
import de.unigoettingen.sub.commons.ocrComponents.hazelcast.HazelcastExecuter;
...
public class AbbyyOCREngine {
	...
	protected void start() throws InterruptedException {
		...
		for(int i=1 ; i < 4; i++){
       	 	sleep(2000);
       	 	AbbyyOCRProcess a = new AbbyyOCRProcess(i, new Date().getTime(), "A" +i );
       	    ocrProcess.add(a);
           /* sleep(10);
